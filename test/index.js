(function () {
    ...
    var blob = new Blob(['<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Chat (dev)</title><link rel="stylesheet" type="text/css" href="http://dmitrym.github.io/MultiChatOnline/test/chat/chat.css"><link rel="stylesheet" type="text/css" href="http://dmitrym.github.io/MultiChatOnline/test/lib/animate.css"><script src="http://dmitrym.github.io/MultiChatOnline/test/lib/jquery.min.js"></script><script src="http://dmitrym.github.io/MultiChatOnline/test/lib/socket.io.js"></script><script src="http://dmitrym.github.io/MultiChatOnline/test/lib/sockjs.min.js"></script><script>var settings = ' + JSON.stringify(Chat.settings) + ';</script></head><body><div id="chat"></div><script src="http://dmitrym.github.io/MultiChatOnline/test/chat/chat.js"></script><script src="http://dmitrym.github.io/MultiChatOnline/test/chat/chats.js"></script><script>' + channelsString + '</script></body></html>'], {type: "text/plain;charset=utf-8"});
