var Chat = {
    ...
    updateStyles: function () {
        ...
        Chat.dynamicStyles = Chat.addCss(fontCss + '#chat-inner {' + chatInnerStyle + Chat.settings.chatStyle + '} .line {' + bounds + Chat.settings.lineStyle + '}');
    },
    ...
    createMessageTwitch: function (message) {
        ...
        var nick = ('<span class="nick" ' + (Chat.settings.colorNicks ? ('style="color: ' + message.userData.color + '"') : '') + '>' + message.from + '</span>');
        var msg = '<span class="message">' + (Chat.settings.emoticonize ? message.getEmoticonizedMessage() : message.message) + '</span>';
